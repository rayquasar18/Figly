/**
 * Verification email template for Figly.
 * Returns branded HTML with verification button.
 */
export function renderVerificationEmail(name: string, verificationUrl: string): string {
  return `
<!DOCTYPE html>
<html lang="vi">
<head>
  ...
  <title>Xac minh email - Figly</title>
</head>
    ...
    <tr>
      <td style="padding:32px 24px;">
        ...
        <p style="color:#4b5563;font-size:16px;line-height:1.6;margin:0 0 24px;">
          Cam on ban da dang ky tai khoan Figly. Vui long xac minh dia chi email cua ban bang cach nhan nut ben duoi.
        </p>
        <!-- CTA Button -->
        ...
        <p style="color:#6b7280;font-size:14px;line-height:1.5;margin:0 0 8px;">
          Lien ket nay se het han sau <strong>24 gio</strong>.
        </p>
        <p style="color:#9ca3af;font-size:13px;line-height:1.5;margin:16px 0 0;">
          Neu ban khong tao tai khoan tren Figly, vui long bo qua email nay.
        </p>
      </td>
    </tr>
    <!-- Footer -->
